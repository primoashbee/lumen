				...
				<div class="col-lg-8">
					...
					<div class="row mt-4">
						<div class="form-group col-lg-3">
							...
							<date-picker id="valid-until" class="text-xl"  v-model="fields.valid_until" v-bind:class="valid_untilHasError ? 'is-invalid' : ''" v-bind:has-error="valid_untilHasError ? 'is-invalid' : ''"  @datePicked="getDate($event, 'valid_until')" ></date-picker>
...
<script>
	export default{
		...
		methods:{
	        ...
	        submit(){
	        	axios.post('/create/deposit', this.fields)
                .then(res=>{
