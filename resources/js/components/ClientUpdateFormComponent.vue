        ...
        <nav aria-label="breadcrumb">
          ...
          <div class="card-body">
            <form @submit.prevent="submit">
                <h3 class="px-3 text-2xl title mb-4">Basic Information</h3>
                <div class="row px-3">
                ...
                <h3 class="px-3 my-4 title text-2xl">Statutories</h3>
                ...
                <div class="row px-3">
                    <h3 class="col-md-6 my-2 title text-2xl">Personal</h3>
                ...
                <h3 class="px-3 my-4 title text-2xl">Other Income</h3>	
                <div class="row px-3">
                    <div class="form-group col-md-3">
                ...
                <h4 class="my-2 px-3 title text-2xl">Notes</h4>
                <div class="row px-3">
                    <div class="form-group col-md-12">
